...
**Состояние на 2026-09-19:** этап 4 сделан и выложен на рабочий сервер (коммит `59d8738`); вне плана в тот же день добавлены однофайловые форматы других сканеров и KFB (раздел 3) и возвращена кнопка «Этикетка» в обычном режиме просмотра (коммит `22a9cc8`). **Следующая сессия начинается с этапа 5, пункт СК-1.**
