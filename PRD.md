...
**Состояние на 2026-09-20:** этап 4 сделан и выложен на рабочий сервер (коммит `59d8738`); вне плана 2026-09-19 добавлены однофайловые форматы других сканеров и KFB (раздел 3) и возвращена кнопка «Этикетка» в обычном режиме просмотра (коммит `22a9cc8`). Этап 5 сделан, выложен на рабочий сервер и принят заказчиком 2026-09-20 (коммит `f9dddd0`); СК-2 закрыт без работ. Этап 6 сделан, проверен на временном стенде и выложен на рабочий сервер 2026-09-20 (коммит `69eb75b`); заказчик проверяет вживую. **Следующая сессия начинается с этапа 7, верхняя панель значками (В-1).**
