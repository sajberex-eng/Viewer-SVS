...
**Состояние на 2026-09-20:** этап 4 сделан и выложен на рабочий сервер (коммит `59d8738`); вне плана 2026-09-19 добавлены однофайловые форматы других сканеров и KFB (раздел 3) и возвращена кнопка «Этикетка» в обычном режиме просмотра (коммит `22a9cc8`). Этап 5 сделан и проверен на временном стенде 2026-09-20, на рабочий сервер не выложен. **Следующая сессия начинается с этапа 6, пункт ЗГ-6**, а перед этим — замер СК-2 на рабочем сервере после выкладки этапа 5.
