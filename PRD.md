...
## 13. Планируется дальше: аннотации для обучения

Заказчик 2026-09-19 назвал эту работу одной из самых полезных для обучения резидентов и просил учесть её в планах. Подробное задание составляется отдельно, здесь зафиксирован замысел.
