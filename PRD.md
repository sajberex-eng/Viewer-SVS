...
| 10. Инструменты просмотра и связь сканов | Поворот на произвольный угол, отражение, рулетка, меню по правой кнопке, ползунок увеличения убирается; связь половин с учётом отражения, привязка по ориентирам и поправка связи с Shift (раздел 13.7) | 1,5–2 недели | По замечаниям патолога, работавшего в OneCell; решения заказчика 2026-09-20. **Не начат** |
...
- [ ] После привязки по двум ориентирам половины идут синхронно по всему срезу: на другом его конце один и тот же участок виден в обеих половинах; привязка определяет и отражение
- [ ] С зажатым `Shift` двигается и поворачивается только активная половина; после отпускания связь держит новое взаимное положение
- [ ] Поворот в режиме сравнения действует на обе половины; двойной щелчок по-прежнему приближает
...
Порядок работ: Т-1; Т-2 и Т-3 вместе с С-9; Т-4 и Т-5; С-11; С-10.
