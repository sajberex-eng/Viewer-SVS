...
| С-8 | Общий курсор: при связанной навигации положение указателя мыши в одной половине показывается перекрестием в соответствующей точке другой (желательное требование). **Не делается:** 2026-09-20 заказчик подтвердил, что общий курсор не нужен — в двух половинах разные срезы, до отдельной клетки их не сопоставить; вместо него связь половин уточняется привязкой (раздел 13.7, С-10 и С-11) |
