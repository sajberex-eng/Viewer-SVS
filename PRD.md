...
- Стоимость: около 6 полей на фрагмент, картинка ~1500 токенов, ответ короткий — порядка 1–3 центов за стекло на `claude-opus-5`; в четыре раза дешевле на `claude-sonnet-5` (сменить в `config.yaml`).
