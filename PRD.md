...
| С-8 | Общий курсор: при связанной навигации положение указателя мыши в одной половине показывается перекрестием в соответствующей точке другой **Делается в этапе 10** (раздел 13.7): 2026-09-20 заказчик сначала отказался от него, затем в тот же день вернул — «отличное предложение» |
...
- [ ] При связанных половинах перекрестие во второй половине стоит на том же ориентире, на который наведён указатель в первой, — при разном угле половин и при отражении; без связи перекрестия нет
