...
const STRINGS = {
  ru: {
    ...
    'top.compare.tip': 'Открыть второй скан рядом',
    'compare.pick': 'Выберите второй скан',
    'compare.pickOne': 'Отметьте ровно один скан',
    'compare.open': 'Открыть рядом',
    'compare.single': 'Один экран',
    'compare.single.tip': 'Закрыть вторую половину и вернуться к одному скану',
